...
const URLS = {
  ...
  beacon_l05_usb_beacon: 'https://www.mokosmart.com/l05-usb-ble-beacon/',
  ...
  tag_m1p_led_tag: 'https://www.mokosmart.com/m1p-led-tag/',
  tag_m5_high_temp_tag: 'https://www.mokosmart.com/m5-high-temp-resistant-tag/',
};
